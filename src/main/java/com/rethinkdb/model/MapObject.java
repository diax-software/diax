...
public class MapObject<K, V> extends LinkedHashMap<K, V> {
    ...
    @SafeVarargs
    public final com.rethinkdb.model.MapObject<K, V> joining(Map<? extends K, ? extends V>... maps) {
     ...
     */
    public com.rethinkdb.model.MapObject<K, V> with(K key, V value) {
        put(key, value);
        return this;
    }

    public com.rethinkdb.model.MapObject<K, V> without(K key) {
        remove(key);
        return this;
    }
}